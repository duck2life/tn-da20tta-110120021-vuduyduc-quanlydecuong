                                    ...
                                    <div class="card-body">  
                                        <div class="row">   
                                            ...
                                            <div class="form-group col-md-12 text-center">  <!-- Full width for buttons -->  
                                                ...
                                                <a href="{{ url('guest/dashbroad') }}" class="btn btn-success" style="margin-top: 20px; width: 100px;">LÀM MỚI</a>  
                                            </div>  
                                        </div>  
                                    </div>  
                                </form>  
                    ...
                    <table class="table">  
                        ...
                        <tbody>  
                                ...
                                <tr>  
                                    ...
                                    <td>  
                                        <a href="{{ url('guest/view/'.$value->id) }}" class="btn btn-info">Xem</a>                                    
                                        <a href="{{ url('guest/print/'. $value->id) }}" class="btn btn-default">In</a>  
                                    </td>  
                                </tr>  
                            @endforeach  
                        </tbody>  
