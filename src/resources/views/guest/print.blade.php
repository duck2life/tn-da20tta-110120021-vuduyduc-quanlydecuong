        ...
        <style>  
            ...
            @media print {  
                ...
                input, textarea {  
                    ...
                    resize: none; /* Disable resizing if you want fixed size */  
                }  
                .no-print {  
                    display: none !important; /* Hide this element when printing */  
                }  
                body {  
                ...
                <div class="form-group row justify-content-center">   
                    <div class="col-sm-12 text-center">  
                        ...
                        <h1 style="font-weight: bold; font-size: 30px;">  
                            <input type="text" class="form-control" name="doc_name" value="{{ old('doc_name', $getData->doc_name) }}" style="display: inline-block; width: 100%; border: none; background: transparent; font-weight: bold; font-size: 32px; text-align: center;" readonly>   
                        </h1>  
        ...
        <tbody>  
                ...
                <td class="equal-width" style="border: 2px solid black;">  
                    <div style="display: flex; justify-content: space-between; align-items: center;">  
                        ...
                        <div>  
                            ...
                            ?>  
                            <span style="margin-right: 5px;">{{ $isCoSoChecked ? '✔' : '✖' }}</span>
                            <br>  
                            <span style="margin-right: 5px;">{{ $isChuyenNganhChecked ? '✔' : '✖' }}</span>  
                        </div>  
                    </div>  
                </td>              
                    ...
                    <div>  
                        ...
                        <?php   
                            ...
                            if (strpos($creditHours, ',') !== false) {  
                                ...
                                $theoryHours = $creditHours;  
                                $practicalHours = 0;  
                            }  
                        ?>  
                        <span>{{ old('credit_theory_hours', trim($theoryHours)) }}</span>  
                        <br>  
                        <label>Thực hành:</label>   
                        <span>{{ old('credit_practical_hours', trim($practicalHours)) }}</span>  
                    </div>   
                </td>  
                    ...
                    <div>  
                        ...
                        <?php   
                            ...
                            if (strpos($teachingHours, ',') !== false) {  
                                ...
                                $teachingTheoryHours = $teachingHours;  
                                $teachingPracticalHours = 0;  
                            }  
                        ?>  
                        <span>{{ old('teaching_hours_theory_hours', trim($teachingTheoryHours)) }}</span>  
                        <br>  
                        <label>Thực hành:</label>   
                        <span>{{ old('teaching_hours_practical_hours', trim($teachingPracticalHours)) }}</span>  
                    </div>  
                </td>  

                <td class="equal-width" style="border: 2px solid black;">  
                    <div>  
                        <span>{{ old('self_study', $getInfo->self_study) }}</span>  
                    </div>   
                </td>  
            </tr>  
        </tbody>  
            ...
            <div class="card-body">  
                <div class="form-group">  
                    ...
                    <span>{{ old('degree', $getSub->degree ?? '') }}</span>  
                </div>  
                
                <div class="form-group">  
                    <label>Ngành: </label>  
                    <span>{{ old('branch', $getSub->branch ?? '') }}</span>  
                </div>  
                
                <div class="form-group">  
                    <label>Chuyên ngành: </label>  
                    <span>{{ old('major', $getSub->major ?? '') }}</span> (nếu có)  
                </div>  

                <div class="form-group">   
                    <label>Năm thứ: </label>  
                    <span>{{ old('year', $getData->year) }}</span>  
                    <br>
                    <label>Học kỳ: </label>  
                    <span>{{ old('semester', $getData->semester) }}</span>  
                </div>  
            </div>  
                ...
                <table class="table table-bordered">  
                    <tbody>  
                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="HPTQ">Học phần tiên quyết</label>  
                            </td>   
                            <td style="width: 80%; border: 2px solid black;">  
                                <input class="form-control" type="text" name="prerequisite" readonly value="{{ old('prerequisite', $getRequi->prerequisite ?? '') }}" style="width: 100%;">  
                            </td>   
                        </tr>   

                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="HPSH">Học phần song hành</label>  
                            </td>  
                            <td style="width: 80%; border: 2px solid black;">  
                                <input class="form-control" type="text" name="corequisite" readonly value="{{ old('corequisite', $getRequi->corequisite ?? '') }}" style="width: 100%;">  
                            </td>    
                        </tr>   

                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="CYCK">Các yêu cầu khác</label>  
                            </td>   
                            <td style="border: 2px solid black;">  
                                <div class="col-sm-12 editor-container">  
                                    <textarea id="myEditor" class="form-control" name="other_requirements" readonly style="width: 100%; text-align: justify;">{{ old('other_requirements', $getRequi->other_requirements ?? '') }}</textarea>  
                                </div>   
                            </td>                          
                        </tr>   
                    </tbody>  
            ...
            <div class="card-body">  
                <table class="table table-bordered">  
                    <tbody>  
                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="GT">Giáo trình/ Tài liệu học tập chính</label>  
                            </td>   
                            <td style="border: 2px solid black;">  
                                <div class="col-sm-12 editor-container">  
                                    <textarea id="myEditor" class="form-control" name="primary_reference" readonly style="width: 100%; text-align: justify;">{{ old('primary_reference', $getRefe->primary_reference ?? '') }}</textarea>  
                                </div>   
                            </td>   
                        </tr>   
                        ...
                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="TLTK">Tài liệu tham khảo thêm</label>  
                            </td>  
                            <td style="border: 2px solid black;">  
                                <div class="col-sm-12 editor-container">  
                                    <textarea id="myEditor" class="form-control" name="additional_reference" readonly style="width: 100%; text-align: justify;">{{ old('additional_reference', $getRefe->additional_reference ?? '') }}</textarea>  
                                </div>   
                            </td>    
                        </tr>   
                        ...
                        <tr style="font-weight: bold; border: 2px solid black;">  
                            <td style="width: 20%; text-align: left; border: 2px solid black;">  
                                <label for="HLK">Các loại học liệu khác</label>  
                            </td>   
                            <td style="border: 2px solid black;">  
                                <div class="col-sm-12 editor-container">  
                                    <textarea id="myEditor" class="form-control" name="other_reference" readonly style="width: 100%; text-align: justify;">{{ old('other_reference', $getRefe->other_reference ?? '') }}</textarea>  
                                </div>   
                            </td>  
                        </tr>   
                    </tbody>  
                ...
                <div class="col-sm-10 editor-container">  
                    <textarea style="text-align: justify;" id="myEditor" class="form-control" name="description" readonly>{{ old('description', $getData->description) }}</textarea>           
                </div>   
                ...
                <div class="card-body">  
                    <table margin="center" class="table table-bordered" id="dynamicTable" style="border: 2px solid black;">  
                        <tr style="font-weight: bold; text-align: center; border: 2px solid black;">  
                            <td style="width: 2%; border: 2px solid black;"></td>  
                            <td style="width: 30%; border: 2px solid black;">Chuẩn đầu ra của học phần</td>  
                            <td style="width: 15%; border: 2px solid black;">Đáp ứng CĐR của CTĐT</td>  
                            <td style="width: 5%; border: 2px solid black;">Trình độ năng lực</td>  
                            <td style="width: 10%; border: 2px solid black;">TUA</td>  
                        </tr>   
            ...
            <br>
                ...
                <div>  
                    <table margin="center" class="table table-bordered" id="fifthTable" style="border: 2px solid black;">   
                        <thead>  
                            <tr  rowspan="2"  style="font-weight: bold; text-align: center; border: 2px solid black;">  
                ...
                <div class="col-sm-10 editor-container">  
                    <textarea style="text-align: justify;" id="myEditor" class="form-control" name="method" readonly>{{ old('method', $getData->method) }}</textarea>  
                </div>   
                </div>
                ...
                <div class="col-sm-10 editor-container">  
                     <textarea style="text-align: justify;" id="myEditor" class="form-control" name="attendance" readonly>{{ old('attendance', $getRegulation->attendance ?? '') }}</textarea>  
                </div>   
                ...
                <div class="col-sm-10 editor-container">  
                   <textarea style="text-align: justify;" id="myEditor" class="form-control" name="behavior" readonly>{{ old('behavior', $getRegulation->behavior ?? '') }}</textarea>  
                </div>   
                ...
                <div class="col-sm-10 editor-container">  
                    <textarea style="text-align: justify;" id="myEditor" class="form-control" name="academic" readonly>{{ old('academic', $getRegulation->academic ?? '') }}</textarea>  
                </div>   
                ...
                <div class="col-sm-11 editor-container">   
                    <textarea style="width: 100%; text-align: justify;" id="myEditor" class="form-control" name="participant" readonly>{{ old('participant', $getData->participant) }}</textarea>  
                </div>   
                <div>  
                    <label style="width: 100%; text-align: justify;">Ngày phê duyệt: ……………………………………………</label>  
                </div>  
                ...
                <div class="card-body">  
                    <table class="table">  
                        <tbody>  
                            ...
                            <tr style="font-weight: bold; color: none; border: 2px solid white;">  
                                <td style="height: 130px; font-weight: bold; color: none; border: 2px solid white;"></td>  
                            </tr>

                            <tr style="font-weight: bold; border: 2px solid white;">  
                                <td style="width: 33%; text-align: center; vertical-align: middle;  border: 2px solid white; font-size: 20px;"></td>  
                                <td style="width: 33%; text-align: center; vertical-align: middle;  border: 2px solid white; font-size: 20px;"></td>  
                                <td style="width: 33%; text-align: center; vertical-align: middle;  border: 2px solid white; font-size: 20px;">  
