        ...
        <div class="row">
          ...
          @include('_message')
            ...
            <div class="card card-primary">
              ...
              <form action="{{ url('admin/document/add') }}" method="POST">
                {{ csrf_field() }}
               ...
               <div class="card-body">  
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input class="col-md-3" type="text" class="form-control" name="degree" >
                  </div>
                  <div class="form-group">
                    <label>Ngành:</label>
                    <input class="col-md-3" type="text" class="form-control" name="branch" >
                  </div>
                  <div class="form-group">
                    <label>Chuyên ngành:
