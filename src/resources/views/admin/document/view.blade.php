        ...
        <div class="container-fluid">  
            <div class="row mb-2">  
                ...
                <div class="col-sm-6 text-right">  
                    <a href="{{ url('admin/document/print/' . $getData->id) }}" class="btn btn-primary btn-lg float-right">Print</a>  
                </div>  
            </div>  
        </div>  
    </section>
                ...
                <div class="form-group row justify-content-center">   
                    <div class="col-sm-12 text-center">  
                        ...
                        <h3 style="font-weight: bold; font-size: 24px; text-align: right;">  
                            MSHP: <input type="number" class="form-control" name="mhp" value="{{ old('mhp', $getData->mhp) }}" style="display: inline-block; width: 50%; border: none; background: transparent; font-weight: bold; font-size: 24px;" readonly>  
                        </h3>  
                    </div>  
                </div>  
                ...
                <div class="card-body">  
                    <table margin="center" class="table table-bordered" id="dynamicTable" style="border: 2px solid black;">  
                        <tr style="font-weight: bold; text-align: center; border: 2px solid black;">  
                            ...
                            <td style="width: 7%; border: 2px solid black;">Trình độ năng lực</td>  
