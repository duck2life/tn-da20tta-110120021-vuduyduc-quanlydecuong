      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('teacher/document/add') }}" class="btn btn-primary">Thêm đề cương</a>
          </div>
        </div>
      </div>
    </section>
                            ...
                            <div class="row">   
                                <div class="form-group col-md-3">  
                                 ...
                                 <div class="form-group col-md-3">  
                                    ...
                                    <a href="{{ url('teacher/document/list') }}" class="btn btn-success" style="margin-top: 30px;">LÀM MỚI</a>  
                                </div> 
                            </div> 
                        </div>  
                    </form>  
                ...
                <table class="table">  
                    ...
                    <tbody>  
                            ...
                            <tr>  
                                ...
                                <td>  
                                    <a href="{{ url('teacher/document/view/'.$value->id) }}" class="btn btn-info">XEM</a>                                   
                                    <a href="{{ url('teacher/document/edit/'.$value->id) }}" class="btn btn-primary">TÙY CHỈNH</a> 
                                    <a href="{{ url('teacher/document/delete/'.$value->id) }}" class="btn btn-danger">XÓA</a>  
                                    <a href="{{ url('teacher/document/print/'.$value->id) }}" class="btn btn-default" id="printDocumentLink" data-id="{{ $value->id }}">IN</a>  
                                    <a href="{{ url('teacher/document/old/version/'.$value->id) }}" class="btn btn-info">PHIÊN BẢN CŨ</a>  
                                    ...
                                    <script type="text/javascript">  
                                        document.getElementById('printDocumentLink').addEventListener('click', function(event) {  
                                            ...
                                            var printWindow = window.open("{{ url('teacher/document/print/') }}/" + docId, '_blank'); // Open the print document in a new tab  
