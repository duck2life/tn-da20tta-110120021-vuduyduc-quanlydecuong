                                ...
                                <form method="get" action="">  
                                    <div class="card-body">  
                                        <div class="row">   
                                            ...
                                            <div class="form-group col-md-12 text-center">  <!-- Full width for buttons -->  
                                                <button class="btn btn-primary" type="submit" style="margin-top: 20px; width: 100px;">TÌM KIẾM</button>  
                                                <a href="{{ url('teacher/dashbroad') }}" class="btn btn-success" style="margin-top: 20px; width: 100px;">LÀM MỚI</a>  
                                            </div>  
                                        </div>  
                                    </div>  
                                </form>  
                        ...
                        <tbody>  
                                ...
                                <tr>  
                                    ...
                                    <td>  
                                        ...
                                        <a href="{{ url('teacher/document/print/'. $value->id) }}" class="btn btn-default">IN</a> 
                                    </td>  
                                </tr>  
                            @endforeach  
                        </tbody>  
