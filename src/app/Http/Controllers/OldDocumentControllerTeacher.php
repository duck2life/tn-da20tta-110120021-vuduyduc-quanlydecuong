...
class OldDocumentControllerTeacher extends Controller
{
    ...
    {  
        ...
        return view('teacher.document.old.version', $doc);  
    }  
    ...
    {  
        ...
        if (!empty($data['getSub'])) {  
            ...
            return view('teacher.document.old.view', $data);  
        } else {  
            abort(404);  
        }  
    }
...
{  
    ...
    return view('teacher.document.old.view', [  
